...
> 
> **Please reinstall this package if you get a 'server not found' error when running the getRvcData() function**
> 
> **Run devtools::install_github('jeremiaheb/rvc') to update to latest package version 2.0.0**
