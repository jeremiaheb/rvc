...
#' }
#' @examples
#' ## Get RVC data from 2011 in the Florida Keys
#' fk2011 = getRvcData(years = 2011, regions = "FLA KEYS")
#'
#' ## Calculate PSU density for Red Grouper
#' getPSUDensity(fk2011, species = "Red Grouper")
