...
getStratumData = function(years, regions, server = 'https://ncrmp-data-entry.fisheries.noaa.gov/rvc_analysis20/') {
...
getRvcData = function(years, regions, server = 'https://ncrmp-data-entry.fisheries.noaa.gov/rvc_analysis20/'){
...
#' }
getBenthicData = function(years, regions, server = 'https://ncrmp-data-entry.fisheries.noaa.gov/rvc_analysis20/') {
...
#' @param u
#' A string. The URL at which to find the file = https://ncrmp-data-entry.fisheries.noaa.gov/rvc_analysis20/
#' @param zipped
