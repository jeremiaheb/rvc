#' @title A statistical package for South Florida's Reef Visual Census
#' @description Provides fisheries managers and scientists with
...
#'
#' Bohnsack, James A., Scott P. Bannerot (1986). "A stationary
#' visual census technique for qualitatively assesing community
#' structure of coral reef fishes". NOAA Technical Report NMFS 41.
#' \url{http://docs.lib.noaa.gov/noaa_documents/NMFS/TR_NMFS/TR_NMFS_41.pdf}
NULL
